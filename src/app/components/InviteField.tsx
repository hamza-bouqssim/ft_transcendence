...
const InviteField = () => {
	return (
		<div className="flex h-[65px] w-full items-center justify-between rounded-[15px] p-2 hover:bg-[#E4E4E4]">
			<div className="ml-[.2rem] h-[50px] w-[50px] shrink-0 overflow-hidden rounded-[50%] bg-black">
				<Image
			...
			<FontAwesomeIcon
				icon={faUserPlus}
				className="h-5 w-5 rounded-[50%] bg-[#5B8CD4] p-3 hover:cursor-pointer hover:bg-[--pink-color]"
			/>
		</div>
	);
};

...
const CoversationPage = () => {
	...
	return (
		<div className="flex  h-screen w-full xl:container xl:mx-auto">
			<div className="h-full  w-full xl:w-[35%] xl:p-10 xl:pl-5  xl:pr-2 ">
				<CoversationSideBar conversations={conversation} />
			</div>
			<div className="hidden w-full  items-center justify-center xl:my-10  xl:ml-2 xl:mr-10 xl:mt-32 xl:flex xl:w-[65%] xl:rounded-[20px]">

...
class PongGame {
  ...
  defaultGameMap = (): void => {
    ...
    this.ball = Bodies.circle(
      this.divWidth / 2,
      this.divHeight / 2,
      this.map(10, 0, this.defaultCanvasSizes.width, 0, this.divWidth),
      {
        label: "ball",
        render: {
          fillStyle: "#FFF",
    ...
    this.separator = Bodies.rectangle(
      ...
      this.divHeight / 2,
      this.divWidth,
      this.map(4, 0, this.defaultCanvasSizes.height, 0, this.divHeight),
      {
        isSensor: true,
        render: {
          fillStyle: "#CFF4FF",
    ...
    this.centerCirle = Bodies.circle(
      this.divWidth / 2,
      this.divHeight / 2,
      this.map(4, 0, this.defaultCanvasSizes.width, 0, this.divWidth),
      {
        isSensor: true,
        render: {
          fillStyle: "#CFF4FF",
  ...
  updateBallVelocity = (): void => {
    ...
    if (
      this.currentBallVelocity.y >= 12 ||
      (this.currentBallVelocity.y < 0 && this.currentBallVelocity.y >= -12)
    )
      return;

		...
		<>
			...
			<div className="fixed right-0 top-6 z-50  flex h-12 w-64 items-center justify-end gap-2 rounded-l-3xl lg:right-7 min-[1750px]:h-14 min-[1750px]:w-80 min-[1750px]:gap-4">
				<div className="relative ">
					...
					{notfication && <NotificationComponent></NotificationComponent>}
				</div>
			...
			{notfication && (
				<div className=" absolute bottom-0 left-0 right-0 top-0 z-10 opacity-100  backdrop-blur-md"></div>
			)}
		</>
	);
};

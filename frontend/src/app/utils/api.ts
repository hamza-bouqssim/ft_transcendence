...
export const postRegisterUser = async (data: createUserParams) =>
  axios.post(`http://10.11.6.2:8000/auth/signup`, data, config);

export const postLoginUser = async (data: UserCredentialsParams) =>
  axios.post(`http://10.11.6.2:8000/auth/signin`, data, config);

export const getAuthUser = () =>
  axios.get<User>(`http://10.11.6.2:8000/user/info`, config);

export const getConversation = () =>
  axios.get(`http://10.11.6.2:8000/chat/findconversation`, config);
...
export const createConversation = async (
  ...
  axios.post(
    `http://10.11.6.2:8000/chat/conversation`,
    { display_name: display_name, message: message },
    config
  );
export const getConversationMessage = (id: string) =>
  axios.get(`http://10.11.6.2:8000/chat/messages/${id}`, config);
export const markConversationAsRead = (id: string) =>
  axios.get(`http://10.11.6.2:8000/chat/${id}/mark-as-read`, config);
export const loginGoogle = () =>
  axios.get(`http://10.11.6.2:8000/auth/google/login`, config);

export const getlogout = () =>
  axios.get(`http://10.11.6.2:8000/auth/logout`, config);

export const postNewMessage = async (data: CreateMessageParams) =>
  axios.post(`http://10.11.6.2:8000/chat/create_messages`, data, config);

// get all friends

export const getAllFriends = () =>
  axios.get(`http://10.11.6.2:8000/user/my-friends`, config);

export const getRequest = () => {
  const response = API.get(`http://10.11.6.2:8000/user/pending-requests`);
  return response;
};

export const getNotification = () =>
  axios.get(`http://10.11.6.2:8000/user/notification`, config);
export const getBloques = () =>
  axios.get(`http://10.11.6.2:8000/user/blocked-friends`, config);

export const DebloqueUser = async (id: string) =>
  axios.post(
    `http://10.11.6.2:8000/friend-request/unblock-friend`,
...
export const bloqueFriend = async (id: string) =>
  axios.post(
    `http://10.11.6.2:8000/friend-request/block-friend`,
    { friendIdToBlock: id },
    config
  );
...
export const SendRequest = async (display_name: string) =>
  await axios.post(
    `http://10.11.6.2:8000/friend-request/send-request`,
...
export const sendRequestPlay = async (display_name: string) =>
  await axios.post(
    `http://10.11.6.2:8000/friend-request/send-request-play`,
    { display_name: display_name },
    config
  );
export const acceptRequestToPlay = async (requestId: string) =>
  await axios.post(
    `http://10.11.6.2:8000/friend-request/accept_request_play`,
    { requestId: requestId },
    config
  );
export const refusePLayRequest = async (requestId: string) =>
  await axios.post(
    `http://10.11.6.2:8000/friend-request/refuse-request-play`,
    { requestId: requestId },
    config
  );
export const pending_request_play = () =>
  axios.get(`http://10.11.6.2:8000/user/pending-request-play`, config);

export const getAllUsers = async () =>
  axios.get(`http://10.11.6.2:8000/user/All-users`, config);

//count number of the notification

export const getNumberNotification = async () =>
  axios.get(`http://10.11.6.2:8000/friend-request/notification_count`, config);
export const getNumberPending = async () =>
  axios.get(`http://10.11.6.2:8000/user/count-pending`, config);

export const AcceptRequest = async (id: string) =>
  axios.post(
    `http://10.11.6.2:8000/friend-request/accept-request`,
    { requestId: id },
    config
  );
...
export const refuseRequest = async (id: string) =>
  axios.post(
    `http://10.11.6.2:8000/friend-request/refuse-request`,
    { requestId: id },
    config
  );
...
export const deleteNotification = async (idNotif: string) =>
  axios.post(
    `http://10.11.6.2:8000/friend-request/delete-notification`,
    { idNotif: idNotif },
    config
  );
...
export const changeDisplayedName = async (DisplayName: string) =>
  axios.post(
    `http://10.11.6.2:8000/user/changedisplayname`,
...
export const changeUserName = async (UserName: string) =>
  axios.post(
    `http://10.11.6.2:8000/user/changeusername`,
...
export const dataUser = async (id_user: string | string[]) =>
  axios.post(
    `http://10.11.6.2:8000/user/get_user`,
    { id_user: id_user },
    config
  );
...
export const getUnreadMessages = async (conversationId: string) =>
  axios.post(
    `http://10.11.6.2:8000/chat/unread-messages`,
...
export const removeFriendship = async (display_name: string) =>
  axios.post(
    `http://10.11.6.2:8000/friend-request/remove-friendship`,
    { display_name: display_name },
    config
  );
//delete conversation
...
export const deleteConversation = async (conversationId: string) =>
  axios.post(
    `http://10.11.6.2:8000/chat/delete-conversation`,
    { conversationId: conversationId },
    config
  );
export const changeAvatar = async (avatarFormData: FormData) => {
  ...
  return axios.post(
    `http://10.11.6.2:8000/user/changeAvatar`,
    avatarFormData,
    config
  );
};
export const searchingBar = async (name: string) =>
  axios.post(
    `http://10.11.6.2:8000/friend-request/search`,
    { name: name },
    config
  );
export const getAllRequests = async () =>
  axios.get(`http://10.11.6.2:8000/user/all-pending-request`, config);
...
export const findConversationUsers = async (
  ...
  axios.post(
    `http://10.11.6.2:8000/chat/findConversationUser`,
    { display_name: display_name, message: message },
    config
  );
// tabel friends
...
export const blockedUsers = async () =>
  axios.get(`http://10.11.6.2:8000/friend-request/blocked`, config);

export const tableFriends = async () =>
  axios.get(`http://10.11.6.2:8000/user/table-friends`, config);

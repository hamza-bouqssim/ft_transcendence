...
export class GameService {
    ...
    async updateStateGame(win : number,lose: number,numberOfMatch: number, userId: string) {
    ...
    async updateAchievement(win : number,lose: number,level: number, userId: string) {
